...
While ts-io automates the process of inferring types for actions and listeners, users may occasionally require access to their contract's types for various purposes. ts-io offers utility types designed to facilitate the inference of contract actions and listeners effortlessly.

## Inferring Types in ts-io
